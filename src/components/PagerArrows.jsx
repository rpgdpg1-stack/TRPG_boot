 ...
 * пальцы). Нажатие — общий паттерн «наверх»: кружок растёт, серый фон уходит
 * на ступень светлее, и вместе с ним ярче становится зелёный шеврон — одно
 * правило осветляет и подложку, и значок. Доступное направление — акцентный зелёный, как у всех живых действий;
