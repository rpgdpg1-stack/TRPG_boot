 ...
 *  - meta        — строка «~1 ч 24 мин · 12 упражнений» под днями (Главная).
...
export default function ProgramCard({
  ...
  press = true,
  lastTrained = false,
  // Строка «~1 ч 24 мин · 12 упражнений» под днями. Включаем на ГЛАВНОЙ: там
  // карточка — единственный источник сведений о тренировке перед запуском.
  // В каталоге не нужна: туда приходят выбирать программу, а не мерить день.
  meta = false,
  bordered = true,
  cta = false,
  footer = null,
