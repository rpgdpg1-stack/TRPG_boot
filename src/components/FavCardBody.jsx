    ...
    <>
      ...
      <div style={styles.content}>
        ...
        {available && (prog.kind === 'swim' ? (
          ...
          <>
            {/* Места (Зал/Дом/Улица) на карточке НЕТ: меняют его редко, и видеть
                каждый день незачем. Узнать и сменить — в меню долгого нажатия. */}
...
const styles = {
  ...
  daysLabel: { fontFamily: 'var(--font-manrope)', fontWeight: 700, fontSize: 'var(--text-button-size)', color: 'var(--text-faint)', letterSpacing: '1px' },
