...
export default function CategoryList() {
  ...
  // Кардио и Растяжка пока СКРЫТЫ визуально (hidden), но структура сохранена —
  // включатся, когда разделы откроются (убрать hidden). Показываем только те,
  // что не hidden.
  const categories = [
    ...
    { id: 'cardio',  iconName: 'cardio',     title: 'Кардио',   subtitle: 'Бег · HIIT',              color: 'var(--cat-cardio)',    comingSoon: true, hidden: true },
    { id: 'stretch', iconName: 'stretching', title: 'Растяжка', subtitle: 'Йога · Пилатес',          color: 'var(--cat-stretch)',   comingSoon: true, hidden: true }
  ].filter(c => !c.hidden)
