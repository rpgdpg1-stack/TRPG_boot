...
// Ширина колонки значения. Фиксированная, а не по содержимому: так колонка
// названия не пляшет от строки к строке. Считана по самому широкому —
 ...
 *
 * Колонка фиксированной ширины (`RECORD_VALUE_W`) прижата к правому краю, число
 * и единица в ней выровнены ПО ПРАВОМУ краю. Так значения всех строк стоят
 * ровным столбиком по одной вертикали — как в таблице, где числа читают справа.
 * Если единицу оставить в строке с числом (как в остальных метриках проекта),
 * столбик разваливается: «тренировок» шире «кг» почти втрое и утаскивает цифру
 * влево.
 *
