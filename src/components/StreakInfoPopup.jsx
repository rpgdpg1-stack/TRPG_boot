 ...
 *
 * Один компонент на все места, где показан бицепс с числом: шапка профиля
 ...
 * впервые видит значок и не понимает, что это за цифра.
 *
...
export default function StreakInfoPopup({ streak = 0, open, onClose, align = 'right', anchorRef }) {
  ...
  return (
    ...
    >
      <div style={styles.title}>Тренировки за неделю</div>
      <div style={styles.body}>
        {n >= 1 ? (
          ...
          'На этой неделе тренировок ещё нет. Заверши первую — бицепс оживёт.'
        )}
      </div>
    </div>
  )
