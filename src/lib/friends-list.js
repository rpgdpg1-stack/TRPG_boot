 ...
 * нумерации мест), с закрепами и сортировкой по активности (последняя
 * тренировка).
 *
 ...
 *   last_workout_at, pinned_at, is_training, week_workouts }.
 *
 * week_workouts — сколько тренировок у друга на этой неделе (Москва, Пн–Вс).
 * null означает «человек закрыл статистику»: тогда показываем только сам факт
 * активности, без числа.
 *
