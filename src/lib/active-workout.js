...
// Пороги цвета таймера тренировки (сек): до 1 ч — серый (не зелёный, чтобы не
// спорил с зелёной буквой активного дня), 1ч–1ч30 — оранжевый, с 1ч30 — красный.
// Единый источник для таймера дня (WorkoutDay) и времени на карточках
// (главная/избранное/раздел). Ключ green оставлен как имя «первого тира».
export const TIMER_ORANGE_SEC = 3600
export const TIMER_RED_SEC = 5400
export const WORKOUT_TIMER_COLORS = {
  green: 'var(--color-text-secondary)',
  orange: '#F0883E',
  red: '#E84545'
}
