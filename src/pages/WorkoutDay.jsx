...
const styles = {
  ...
  headerCard: {
    position: 'relative',
    overflow: 'hidden',
    // Паддинг задаёт высоту ОБОИХ состояний, поэтому он прежний: пилюля должна
    // остаться той же высоты, что была. Высокую шапку ужимаем не им, а
    // внутренним зазором (headerCardInner).
