...
export default function WorkoutDay() {
  ...
  // Место выбирают в меню долгого нажатия карточки программы — здесь только читаем.
    ...
    <div style={styles.page}>
      ...
      <div ref={stickyHeaderRef} style={styles.stickyHeader}>
        ...
        >
          ...
          {/* Ракета «быстрой» — ВЕРХНИЙ левый угол карточки-шапки (там, где раньше
              стоял тег места: место выбирают теперь в меню карточки программы).
          ...
          <div style={styles.topMetaRow}>
            {/* Переключателя места здесь нет: место выбирают в меню долгого
                нажатия карточки программы, день грузит упражнения уже под него. */}
...
const styles = {
  ...
  // Ракета — левый ВЕРХНИЙ угол карточки-шапки, на линии таймера и крестика.
