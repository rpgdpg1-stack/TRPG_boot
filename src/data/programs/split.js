 ...
 *
 * Структура: 26 слотов всего: A=8, B=8, C=10.
 *
 * Убраны по просьбе Дмитрия (2026-08-11):
 *   - жим штанги лёжа (ex_017) — оставили наклонный жим гантелей и бабочку;
 *   - шея, два упражнения (ex_086/ex_087) — травмоопасно и нужно не каждому,
 *     кому надо, добавит себе сам в своей программе.
 */
...
export const SPLIT_PROGRAM = {
  days: {
    A: [
      ...
      { order_num: 8, muscle_group: 'back',     sub_group: 'extensors',         type: 'accessory', default_exercise_id: 'ex_013' }
    ],
    B: [
      { order_num: 1, muscle_group: 'chest',     sub_group: 'chest_upper',       type: 'base',      default_exercise_id: 'ex_024' },
      { order_num: 2, muscle_group: 'chest',     sub_group: 'chest',             type: 'isolation', default_exercise_id: 'ex_022' },
      { order_num: 3, muscle_group: 'shoulders', sub_group: 'front_delt',        type: 'base',      default_exercise_id: 'ex_055' },
      { order_num: 4, muscle_group: 'shoulders', sub_group: 'mid_delt',          type: 'isolation', default_exercise_id: 'ex_058' },
      { order_num: 5, muscle_group: 'shoulders', sub_group: 'rear_delt',         type: 'isolation', default_exercise_id: 'ex_059' },
      { order_num: 6, muscle_group: 'triceps',   sub_group: 'triceps',           type: 'isolation', default_exercise_id: 'ex_071' },
      { order_num: 7, muscle_group: 'triceps',   sub_group: 'triceps',           type: 'isolation', default_exercise_id: 'ex_070' },
      { order_num: 8, muscle_group: 'abs',       sub_group: 'abs_upper',         type: 'isolation', default_exercise_id: 'ex_078' }
    ],
    C: [
      ...
      { order_num: 9,  muscle_group: 'legs', sub_group: 'calves',     type: 'isolation', default_exercise_id: 'ex_051' },
