 ...
 *
 * id 'prog_001' соответствует записи в таблице programs в Supabase.
 * Этот id используется как program_id в workouts/exercise_sets/user_exercise_swaps.
 *
 ...
 * Принимаем оба варианта id: 'split' (старый, в URL) и 'prog_001' (в БД).
 */
