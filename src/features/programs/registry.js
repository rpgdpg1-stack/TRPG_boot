...
export const PROGRAMS = [
  ...
  },
  {
    ...
    available: true,
    comingSoon: false,
    // Пробный вид списка: заголовков групп над карточками НЕТ, вместо них тег
    // внутри карточки показывает «Группа — Подгруппа» («Ноги — Бицепс бедра»).
    // В фулбади группы чередуются почти каждую строку, и заголовок над каждой
    // карточкой превращался бы в мусор. Зайдёт — тем же флагом включим сплиту.
