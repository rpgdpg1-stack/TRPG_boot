...
Автодеплоя нет: правка в репозитории не означает правку в бою. Функций три
(`telegram-auth`, `email-request-code`, `email-verify-code`) — и все три про
вход. Сломается деплой — никто не войдёт, включая тебя.
